public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(
                "  Position noeud 0 : (" + g1.getNoeudById(0).getAbs() + ", " + g1.getNoeudById(0).getOrd() + ")");
        ...
        float dist = n1.distanceTo(n2, false);
        ...
        // TEST 6 : Distance entre deux noeuds (geo)
        System.out.println("TEST 6 : Calcul de distance"); 
        Noeud n11 = new Noeud(0, 16.47, 96.1);
        Noeud n22 = new Noeud(1, 20.09, 92.54);
        double dist1 = n11.distanceTo(n22, true);
